 ...
 */
final class Version20210520075345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, studio_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT NULL, release_date INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, synopsis LONGTEXT DEFAULT NULL, seen TINYINT(1) NOT NULL, watch_list TINYINT(1) DEFAULT NULL, INDEX IDX_1D5EF26F446F285F (studio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
