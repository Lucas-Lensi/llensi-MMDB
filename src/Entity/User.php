...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Movie::class, mappedBy="seen")
     */
    private $seenMovies;

    /**
     * @ORM\ManyToMany(targetEntity=Movie::class, mappedBy="watchList")
     */
    private $watchList;
    ...
    {
        if ($this->seenMovies->removeElement($seenMovie)) {
            $seenMovie->removeSeen($this);
        }
